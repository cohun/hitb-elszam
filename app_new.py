...
if view_mode == "📊 Fő Dashboard":
    ...
    edited_df = st.data_editor(
        styled_view_df,
        column_config={
            "SzumBeker": st.column_config.NumberColumn(format="%d Ft"),
            "SzumElad": st.column_config.NumberColumn(format="%d Ft"),
            "Rés": st.column_config.NumberColumn(format="%d Ft"),
            "Jut": st.column_config.NumberColumn(format="%d Ft"),
            "Jut_%": st.column_config.NumberColumn(format="%.2f"),
